          ...
          <div className="mt-6">
            ...
            <div className="flex items-center">
              <div className="flex items-center">
                ...
                {
                  Array(Math.ceil(product.rating)).fill(0).map((rating,i)=>{
                  ...
                  </svg> :<img className='h-5 w-5' src="https://www.iconbolt.com/preview/twitter/news-and-media/star-half-empty.svg" alt="" />
